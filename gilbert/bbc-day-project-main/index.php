  ...
  <body>
    ...
    <div class="login-popup" id='registerForm'>
      ...
      <form>
        ...
        <input type="text" id="lastName" name="" /><br />
        <label for="fname">Reg Number:</label>
        <input type="text" id="regNumber"name="" /><br />
        <label for="fname">Year of study:</label>
        <input type="number" id="yearOfStudy" /><br/>
        <button type="button" onclick="register(),clearForm()">Register</button>
